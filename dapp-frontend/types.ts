...
export interface NetworkConfig {
  ...
  multiSigSigners?: AccountId[];      // Multi-signature signers for factory
  governanceAccount?: AccountId;      // DAO governance account
  factoryAccount?: AccountId;         // Factory account address
}
